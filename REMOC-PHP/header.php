...
<head>
    ...
    <!-- Prefetch --><!-- Carga la 2da mas importante -->
    <link rel="prefetch" href="Contactenos.html" as="document">

    <link rel="preload" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Krub:wght@400;700&display=swap" rel="stylesheet">

    <link rel="preload" href="css/style.css" as="style"><!--carga la hoja rapido-->
...
<header class="header">
            ...
            <div class="barra"> 
                ...
                width="25" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" 
