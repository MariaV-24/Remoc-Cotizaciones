...
/*para jalar el nombre del campo especifico, vamos a colocar lo que pusimos en el  atributo nombre de cd campo*/
...
if (isset($_POST['enviar'])) {
    ...
    if (!empty($_POST['nombre']) && !empty($_POST['telefono']) 
        ...
        && !empty($_POST['msj']) && !empty($_POST['correo'])) {
            ...
            $body = "nombre: " . $nombre . "<br>telefono: " . $telefono .
                    "<br>nombreProducto: " . $nombreProducto .      
                    "<br>msj: " . $msj . "<br>correo: " . $correo;
        ...
        try {
            ...
            $mail->Username   = 'gestionproyectosmusade@gmail.com';                     //SMTP usernombre
            ...
            $mail->setFrom('gestionproyectosmusade@gmail.com', $nombre);
