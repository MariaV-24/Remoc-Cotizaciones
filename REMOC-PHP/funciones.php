...
//funciones
 ...
 /*****************************************************************************************************************************************/
    ...
    'SELECT 
        ...
        producto_categorias.ProductoIDProd, 
        producto_categorias.CategoriasIDCateg, 
    ...
    INNER JOIN producto_categorias
    ON imagen_producto.IDProd = producto_categorias.ProductoIDProd

    INNER JOIN categorias
    ON producto_categorias.CategoriasIDCateg = categorias.IDCateg 

    INNER JOIN producto
    ON producto.IDProd = imagen_producto.IDProd

    WHERE categorias.IDCateg = 1;'
    ;
